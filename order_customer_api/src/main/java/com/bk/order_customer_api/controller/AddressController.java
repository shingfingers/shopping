...
public class AddressController {
     ...
     */
    @PostMapping("/add")
    public BaseResult add(@RequestHeader("userId") Long userId, @RequestBody Address address){
     ...
     */
    @PutMapping("/update")
    public BaseResult update(@RequestHeader("userId") Long userId, @RequestBody Address address){
        address.setUserId(userId);
    ...
    public BaseResult<List<Address>> findByUser(@RequestHeader("userId") Long userId){
