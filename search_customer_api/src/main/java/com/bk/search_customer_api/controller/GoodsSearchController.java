package com.bk.search_customer_api.controller;

import com.bk.common.pojo.GoodsDesc;
import com.bk.common.pojo.GoodsSearchParam;
import com.bk.common.pojo.GoodsSearchResult;
...
public class GoodsSearchController {
    ...
    public BaseResult<List<String>> autoSuggest(@RequestParam("keyword") String keyword){
     ...
     */
    @GetMapping("/findDesc")
    public BaseResult<GoodsDesc> findDesc(@RequestParam("id") Long id){
