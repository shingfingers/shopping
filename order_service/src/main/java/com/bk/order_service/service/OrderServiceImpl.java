...
import com.bk.order_service.mapper.CartGoodsMapper;
import com.bk.order_service.mapper.OrdersMapper;
...
public class OrderServiceImpl implements OrdersService {
    ...
    public Orders add(Orders orders) {
        ...
        try {
            ...
            // RocketMQ 异常不影响支付主流程（订单已入库）
            System.out.println("发送订单超时检查消息失败: " + e.getMessage());
        }
        return orders;
    }
